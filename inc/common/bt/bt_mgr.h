...
public:
	...
	int32_t register_action(const char* pcszName);
	...
	int32_t start_run(BT_CTX& rCtx, int32_t nTreeID, int32_t nEventID, int32_t nOwnerType,
		void* pOwner, uint64_t qwOwnerID, CLuaScript* pScript, int64_t llVar0 = 0, int64_t llVar1 = 0,
