...
#else
	#define CRI(__fmt__, ...) 	tlog_crit(g_pSvrLogCat, 0, 0, __fmt__, __VA_ARGS__)
	#define WRN(__fmt__, ...) 	tlog_warn(g_pSvrLogCat, 0, 0, __fmt__, __VA_ARGS__)
	#define ERR(__fmt__, ...)   tlog_error(g_pSvrLogCat, 0, 0, __fmt__, __VA_ARGS__)
	#define INF(__fmt__, ...)   tlog_info(g_pSvrLogCat, 0, 0, __fmt__, __VA_ARGS__)
	#define DBG(__fmt__, ...)   tlog_debug(g_pSvrLogCat, 0, 0, __fmt__, __VA_ARGS__)
#endif
