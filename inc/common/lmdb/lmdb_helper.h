...
BOOL lmdb_puts(MDB_txn *txn, MDB_dbi dbi, char* keystr, int32_t in);
BOOL lmdb_gets_int(MDB_env *env, MDB_dbi dbi, char* keystr, int32_t *out);
BOOL lmdb_puts_int(MDB_env *env, MDB_dbi dbi, char* keystr, int32_t in);
