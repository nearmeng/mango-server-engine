...
const ::google::protobuf::Descriptor* SS_HEAD_descriptor_ = NULL;
const ::google::protobuf::internal::GeneratedMessageReflection*
  SS_HEAD_reflection_ = NULL;
...
void protobuf_AssignDesc_proto_5fhead_2eproto() {
  ...
  CS_HEAD_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      ...
      sizeof(CS_HEAD));
  SS_HEAD_descriptor_ = file->message_type(1);
  static const int SS_HEAD_offsets_[3] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(SS_HEAD, msgid_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(SS_HEAD, src_addr_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(SS_HEAD, router_id_),
  };
  SS_HEAD_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      SS_HEAD_descriptor_,
      SS_HEAD::default_instance_,
      SS_HEAD_offsets_,
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(SS_HEAD, _has_bits_[0]),
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(SS_HEAD, _unknown_fields_),
      -1,
      ::google::protobuf::DescriptorPool::generated_pool(),
      ::google::protobuf::MessageFactory::generated_factory(),
      sizeof(SS_HEAD));
...
void protobuf_RegisterTypes(const ::std::string&) {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
    SS_HEAD_descriptor_, &SS_HEAD::default_instance());
}
...
void protobuf_ShutdownFile_proto_5fhead_2eproto() {
  ...
  delete SS_HEAD::default_instance_;
  delete SS_HEAD_reflection_;
}
...
void protobuf_AddDesc_proto_5fhead_2eproto() {
  ...
  static const char descriptor[] = {  "\n\020proto_head.proto\"\'\n\007CS_HEAD\022\r\n\005msgid\030\001"
      ...
      "\001 \002(\005\022\020\n\010src_addr\030\002 \002(\005\022\021\n\trouter_id\030\003 \001"
      "(\006"
  };
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(    descriptor, 122);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "proto_head.proto", &protobuf_RegisterTypes);
  CS_HEAD::default_instance_ = new CS_HEAD();
  SS_HEAD::default_instance_ = new SS_HEAD();
  CS_HEAD::default_instance_->InitAsDefaultInstance();
  SS_HEAD::default_instance_->InitAsDefaultInstance();
...
#ifndef _MSC_VER
const int SS_HEAD::kMsgidFieldNumber;
const int SS_HEAD::kSrcAddrFieldNumber;
const int SS_HEAD::kRouterIdFieldNumber;
#endif  // !_MSC_VER

SS_HEAD::SS_HEAD()
  : ::google::protobuf::Message() {
  SharedCtor();
  // @@protoc_insertion_point(constructor:SS_HEAD)
}

void SS_HEAD::InitAsDefaultInstance() {
}

SS_HEAD::SS_HEAD(const SS_HEAD& from)
  : ::google::protobuf::Message() {
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:SS_HEAD)
}

void SS_HEAD::SharedCtor() {
  _cached_size_ = 0;
  msgid_ = 0;
  src_addr_ = 0;
...
SS_HEAD::~SS_HEAD() {
  // @@protoc_insertion_point(destructor:SS_HEAD)
  SharedDtor();
}

void SS_HEAD::SharedDtor() {
  if (this != default_instance_) {
  }
}

void SS_HEAD::SetCachedSize(int size) const {
  GOOGLE_SAFE_CONCURRENT_WRITES_BEGIN();
  _cached_size_ = size;
  GOOGLE_SAFE_CONCURRENT_WRITES_END();
}
const ::google::protobuf::Descriptor* SS_HEAD::descriptor() {
  protobuf_AssignDescriptorsOnce();
  return SS_HEAD_descriptor_;
}

const SS_HEAD& SS_HEAD::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_proto_5fhead_2eproto();
  return *default_instance_;
}

SS_HEAD* SS_HEAD::default_instance_ = NULL;

SS_HEAD* SS_HEAD::New() const {
  return new SS_HEAD;
}

void SS_HEAD::Clear() {
#define OFFSET_OF_FIELD_(f) (reinterpret_cast<char*>(      \
  &reinterpret_cast<SS_HEAD*>(16)->f) - \
   reinterpret_cast<char*>(16))
...
bool SS_HEAD::MergePartialFromCodedStream(
    ::google::protobuf::io::CodedInputStream* input) {
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:SS_HEAD)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(127);
    tag = p.first;
    if (!p.second) goto handle_unusual;
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        ...
        if (input->ExpectTag(16)) goto parse_src_addr;
        break;
      }
      ...
      case 2: {
        ...
        if (input->ExpectTag(25)) goto parse_router_id;
        break;
      }
...
success:
  // @@protoc_insertion_point(parse_success:SS_HEAD)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:SS_HEAD)
  return false;
#undef DO_
}

void SS_HEAD::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:SS_HEAD)
  // required int32 msgid = 1;
  if (has_msgid()) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(1, this->msgid(), output);
  }
  ...
  // required int32 src_addr = 2;
  if (has_src_addr()) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(2, this->src_addr(), output);
  }

  // optional fixed64 router_id = 3;
  if (has_router_id()) {
    ::google::protobuf::internal::WireFormatLite::WriteFixed64(3, this->router_id(), output);
  }
  ...
  // @@protoc_insertion_point(serialize_end:SS_HEAD)
}

::google::protobuf::uint8* SS_HEAD::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:SS_HEAD)
  // required int32 msgid = 1;
  if (has_msgid()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(1, this->msgid(), target);
  }
  ...
  // required int32 src_addr = 2;
  if (has_src_addr()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(2, this->src_addr(), target);
  }

  // optional fixed64 router_id = 3;
  if (has_router_id()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteFixed64ToArray(3, this->router_id(), target);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:SS_HEAD)
  return target;
}

int SS_HEAD::ByteSize() const {
  int total_size = 0;
...
void SS_HEAD::MergeFrom(const ::google::protobuf::Message& from) {
  GOOGLE_CHECK_NE(&from, this);
  const SS_HEAD* source =
    ::google::protobuf::internal::dynamic_cast_if_available<const SS_HEAD*>(
      &from);
  if (source == NULL) {
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
...
void SS_HEAD::MergeFrom(const SS_HEAD& from) {
  GOOGLE_CHECK_NE(&from, this);
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    if (from.has_msgid()) {
      set_msgid(from.msgid());
...
void SS_HEAD::CopyFrom(const ::google::protobuf::Message& from) {
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void SS_HEAD::CopyFrom(const SS_HEAD& from) {
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool SS_HEAD::IsInitialized() const {
  if ((_has_bits_[0] & 0x00000003) != 0x00000003) return false;

  return true;
}

void SS_HEAD::Swap(SS_HEAD* other) {
  if (other != this) {
    std::swap(msgid_, other->msgid_);
...
::google::protobuf::Metadata SS_HEAD::GetMetadata() const {
  protobuf_AssignDescriptorsOnce();
  ::google::protobuf::Metadata metadata;
  metadata.descriptor = SS_HEAD_descriptor_;
  metadata.reflection = SS_HEAD_reflection_;
  return metadata;
}
